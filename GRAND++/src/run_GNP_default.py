...
def main(cmd_opt):
    ...
    if opt['trusted_mask']:
      ...
      mask = None
    model = GNN(opt, dataset, device, trusted_mask=mask).to(device) if opt["no_early"] else GNNEarly(opt, dataset,
                                                                                                     device,
                                                                                                     trusted_mask=mask).to(
        device)
    print(opt)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--icxb', action='store_true')
