...
"""
python3 ray_tune.py --dataset ogbn-arxiv \
    --lr 0.005 --add_source --function transformer \
    --attention_dim 16 --hidden_dim 128 --heads 4 \
    --input_dropout 0 --decay 0 --adjoint \
    --adjoint_method rk4 --method rk4 --time 5.08 \
    --epoch 50 --num_samples 1 --name ogbn-arxiv-test \
    --gpus 1 --grace_period 50 
"""
